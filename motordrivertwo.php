  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>Super Debug L298N 2A Dual Motor Driver Module</span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        Driver chip: L298 dual H-bridge driver chip.<br />
        Operates up to 35V DC<br />
        Drive part of the peak current Io: 2A / Bridge<br />
        Logical part of the terminal power supply range Vss :4.5V-5.5V<br />
        Maximum power consumption: 20W<br />
      </p>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
