...
<html lang="en">
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/flying controller2.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>SP Racing F3 Flight Controller</span>
        ...
        <div class="stars">
          ...
          <span>Subtotal:<span id="changeprice">2500</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        This is a best flying controller for drones and robots.It is provided
        best stability for drone.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >SP Racing F3 Flight Controller Specifications</span
      >
      <ul
        style="
          font: 20px solid;
      ...
      >
        <li>
          No compromise I/O. Use all the features all the time; e.g. Connect
          your OSD + SmartPort + SBus + GPS + LED Next-generation STM32 F3
          processor<br> with hardware floating point unit for efficient flight
          calculations and faster ARM-Cortex M4 core.
        </li>
        <li>
          Strip + Battery Monitoring + Sonar + 8 motors – all at the same time!
          On-board <br>high-capacity black box flight log recorder – optimize your
          tuning and see the results of your setup without guesswork ( Deluxe).
        </li>
        <li>
          Next-generation STM32 F3 processor with hardware floating point unit
          for efficient <br>flight calculations and faster ARM-Cortex M4 core.
        </li>
        <li>
          Stackable design perfect for integrating with OSDs and power
          distribution boards.<br> 16 PWM I/O lines for ESCs, Servos and legacy
          receivers.
        </li>
      </ul>
    </div>
