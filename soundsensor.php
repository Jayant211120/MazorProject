  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>LM393 Sound Sensor Module</span>
        ...
        <div class="stars">
          ...
          <span>Subtotal:<span id="changeprice">40</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        This LM393 module works perfectly when you monitor sound. The microphone
        captures the audio waves and compares it using the LM393 comparator IC.
        The sensitivity of the digital output pin can be adjusted using the
      ...
      <span
        style="
          ...
          padding: 10px 0px;
        "
        >Sound Sensor Specifications</span
      >
      <ul
        style="
          font: 20px solid;
