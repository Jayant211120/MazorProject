...
<!-- -------------------------------------------------------------------------------------------------- -->
                <li id="list"><a href="sensors.php">Sensors<span style="color:red">*</span>
...
<label for=""id='centerlabel'> Welcome in Address Page</label>
<div class="rotatetwo">
...
<div class="arrowtwopointthree"></div>
    ...
    <!-- 
        ----------------------------------------------
     -->
    <form action="userkidetailscaptured.php"method=POST>
    <input type="text" placeholder='Enter Name*'name='name'required><br>
    <input type="email" placeholder='Enter Email Address*'name='mail'required><br>
    <input type="number" placeholder='Enter number*'name='num'required><br>
    ...
    <input type="text" placeholder='Enter City/Village*'name='city'required>
    <div class='country'>
        <label for=""style='color:orange;background-color:transparent;font:30px solid'>Country*:</label>
        <div class="onediv">
            <label for="" style='color:orange'>India</label>
    <input type='radio'name='rdioone'>
        </div>
        <div class="twodiv">
            <label for="" style='color:orange'>Other</label>
    <input type='radio'name='rdioone'>
        </div>
    </div>
    <input type="number" placeholder='Enter Pincode*'name='pin'required><br>
    <textarea id="" cols="23.7" rows="5"name='textarea'placeholder='Enter Suggestion'></textarea><br>
