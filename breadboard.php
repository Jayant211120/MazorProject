    ...
    <section id="selections">
      <div class="options">
        ...
        <div class="buttons background-colorone">
          ...
          <form action="breadboardtwo.php" method=POST>
        ...
        <div class="buttons background-colorone">
          <img src="Images/breadboard2.jfif" alt="No Image Found" />
          <form action="breadboardthree.php" method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
        </form>
        </div>
        ...
        <div class="buttons background-colorone">
          <img src="Images/breadboard3.jfif" alt="No Image Found" />
          <form action="breadboardone.php" method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
      ...
      <div class="optionstwo">
        <div class="buttons background-colorone">
          <img src="Images/0pcb.jpg" alt="No Image Found" />
          <form action="zeropcb.php" method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
