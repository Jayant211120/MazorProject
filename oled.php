...
<html lang="en">
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/OLED.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>OLED Display 0.96 Inch I2C Interface / 4 Pin Blue SSD1306</span>
        <div class="stars">
          <div class="starsrow">
          ...
          <span style="padding: 2rem 0px">Availability:200 in stock</span>
          ...
          <span>Subtotal:<span id="changeprice">180</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        OLED displays are popular for their low current consumption and bright
        viewing angles. This 0.96 Inch Monochrome (Blue) OLED display can be
        easily interfaced with microcontrollers like Arduino through I2C/IIC
        Communication. The 0.96" display is driven by the SSD1306 Display Driver
        IC. There are also other versions OLED display with a bigger display,
        different color and few of them can support SPI communication as well.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >OLED Display 0.96 Inch I2C Interface / 4 Pin Blue SSD1306</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>Operating Voltage Range:3.3V to 6V</li>
        <li>Communication:12C</li>
        <li>Resolution:128 x 64</li>
        <li>color:Monochrome(Blue)</li>
        <li>Driver IC:SSD1306</li>
        <li>Module Dimension:27 x 27 x 4.1 mm</li>
        <li>Support both 5v and 3.3v logic</li>  
    </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
