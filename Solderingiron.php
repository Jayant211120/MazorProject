  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        ...
        <div class="stars">
          ...
          <span>Subtotal:<span id="changeprice">100</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        This is a 25-Watt Soldering Iron that is best for students and
        hobbyists. It is a general purpose soldering iron where the soldering
        tip can be changed as per requirements. One can choose a chisel or
        pointed tip which is available separately and is good for solving the
        purposes. The default available tip is the Chisel one with 25-Watt
        rating. It has a long AC cable with Three Pin facility that reduces the
        chances of electrical shock. Maximum Allowed temperature is fixed with
        380 Degree temperature rating. It is designed in a way that the
        soldering iron tip maintains the constant temperature. A hook is also
      ...
      <span
        style="
          ...
          padding: 10px 0px;
        "
        >Soldering Iron Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>Heat Transfer Efficiency Maximize</li>
        <li>Light Weight and Low Price/Cost</li>
        <li>Multi-Color Available</li>
        <li>Safe For Use</li>
      </ul>
    </div>
    >
