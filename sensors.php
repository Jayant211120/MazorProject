    ...
    <section id="selections">
      <div class="options">
        ...
        <div class="buttons background-colorone">
          <img src="Images/sound sensor.jpg" alt="No Image Found" />
          <form action='soundsensor.php'method=POST>
        ...
        <div class="buttons background-colorone">
          ...
          <form action='bluetoothsensor.php'method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
        ...
        <div class="buttons background-colorone">
          ...
          <img src="Images/amplifier.jpg" alt="No Image Found"  disabled/>
          <form action='amplifier.php'method=POST>
      ...
      <div class="optionstwo">
        <div class="buttons background-colorone">
          ...
          <form action='ultrasonicsensor.php'method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
        ...
        <div class="buttons background-colorone">
          <img src="Images/touchsensor.jpg" alt="No Image Found" />
          <form action='touchsensor.php'method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
        ...
        <div class="buttons background-colorone">
          ...
          <form action='temperature and humidity sensor.php'method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
        ...
        <div class="buttons background-colorone">
          ...
          <form action='oled.php'method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
        ...
        <div class="buttons background-colorone">
            <span style='font:2rem solid;color:white'>Not Available</span>
            <img src="Images/gyro.jpg" alt="No Image Found" disabled/>
            <form action='gyro.php'method=POST>
            <button disabled>Add To Card</button>
            <button disabled>Buy/Order</button>
          </form>
        </div>
        <div class="buttons background-colorone">
            ...
            <form action='infraredsensor.php'method=POST>
            <button>Add To Card</button>
            <button>Buy/Order</button>
          </form>
        </div>
