  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>Flux Core Solder Wire 18SWG</span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        The box consists of 50 Grams of 20 SWG solder wire with Flux Core. The
        diameter of the solder wire is 18 SWG. Because the flux 'core' is
        contained in cored solder wire, there is no need to use flux externally,
        and soldering is simple.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >Soldering Iron Wire Specifications</span
      >
      <ul
        style="
          font: 20px solid;
      ...
      >
        <li>
          Type of Solder: Flux Cored Wire (wire having soldering flux inside
          core)
        </li>
        <li>Cost-effective alloy</li>
        <li>Makes smooth shiny joints</li>
        <li>Melting Point: 217 -226 °C</li>
        <li>Diameter: 20 SWG</li>
        <li>Excellent solder joint reliability; Superior joint strength.</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
