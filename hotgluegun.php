  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        ...
        <div class="stars">
          ...
          <span style="padding: 2rem 0px">Availability:1000 in stock</span>
          ...
          <span>Subtotal:<span id="changeprice">160</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        Glue gun are a portable devices that utilizes and dispense hot melted
        adhesives in shape of tubular sticks. The heat generated from the
        heating element melts the adhesive and let it flow to the nozzle by
        pulling the trigger. Generally, melting takes between two and five
        minutes, but the process may be shorter depending on whether the gun has
        been preheated or is already in use. In standard glue guns, the
        ...
        process. Low-temperature guns melt glue at 250 degrees and are suitable
        for delicate materials. High-temperature hot glue sticks and guns can
        reach 400 degrees and are only compatible for more durable or “hard”
        materials. Manufacturers produce dual temperature models for multiple
        projects. It can be used in electronics components fixing, woodworking,
        recreational décor, Shipment and Packaging etc.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >Hot Glue Gun Specifications</span
      >
      <ul
        style="
          font: 20px solid;
