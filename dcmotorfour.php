  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>12 volts 555 DC Motor 12000rpm High Speed</span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      >
          ...
          555 DC Motor is the high torque DC Motor.It is used for drilling in wood,wall and other small parts.
          For PCB drilling is the best option for this motor.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >555 DC Motor Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>12V DC RS-555 Motor</li>
        <li>No Load Power Consumption</li>
        <li>High Torque Rated Voltage</li>
        <li>Drilling, grinding and other small electric drilling</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
