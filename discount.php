...
<html lang="en">
  <head>
    ...
    <title>Motors</title>
    <link rel="stylesheet" href="discountkesath.css" />
    <!-- Icons CDS -->
    <link
      rel="stylesheet"
...
<!-- ----------------------------------------------------------------------------------- -->
    ...
    <section id="selections">
      <div class="options">
        ...
        <span style="font:2rem solid;color:white">25% OFF</span>
        <img src="Images/arduino three.jfif" alt="No Image Found" />
        <form action="arduinonano.php"method=POST>
        ...
        <div class="buttons background-colorone">
            <span style="font:2rem solid;color:white">15% OFF</span>
          <img src="Images/arduino two.jfif" alt="No Image Found" />
          <form action="arduinomega.php"method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
        ...
        <div class="buttons background-colorone">
            <span style="font:2rem solid;color:white">15% OFF</span>
          <img src="Images/arduinoone.jfif" alt="No Image Found" />
          <form action="arduinouno.php"method=POST>
          <button>Add To Card</button>
          <button>Buy/Order</button>
          </form>
        </div>
      ...
      <div class="optionstwo">
        <div class="buttons background-colorone">
          ...
          <img src="Images/servo motor driver.jpg" alt="No Image Found" disabled />
          <button disabled>Add To Card</button>
          <button disabled>Buy/Order</button>
        </div>
        <div class="buttons background-colorone">
            <span style="font:2rem solid;color:white">5% OFF</span>
            <img src="Images/servo motor driver2.webp" alt="No Image Found" />
            <form action="servomotordriver.php"method=POST>
            <button>Add To Card</button>
            <button>Buy/Order</button>
            </form>
          </div>
          <div class="buttons background-colorone">
            <span style="font:2rem solid;color:white">15% OFF</span>
            <span style='font:2rem solid;color:white;'>Not Available</span>
            <img src="Images/motordriver1.jpg" alt="No Image Found" disabled/>
            <button disabled>Add To Card</button>
            <button disabled>Buy/Order</button>
          </div>
          <div class="buttons background-colorone">
            <span style="font:2rem solid;color:white">35% OFF</span>
            <img src="Images/motor driver.jfif" alt="No Image Found" />
            <form action="motordrivertwo.php"method=POST>
            <button>Add To Card</button>
            <button>Buy/Order</button>
            </form>
          </div>
          <div class="buttons background-colorone">
            <span style="font:2rem solid;color:white">35% OFF</span>
            <img src="Images/motor driver2.jfif" alt="No Image Found"/>
            <form action="motordriver.php"method=POST>
            <button >Add To Card</button>
            <button >Buy/Order</button>
            </form>
          </div>
