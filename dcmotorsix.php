  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>12 volts 775 DC Motor 18000rpm High Speed</span>
        ...
        <div class="stars">
          ...
          <span style="padding: 2rem 0px">Availability:50 in stock</span>
          ...
          <span>Subtotal:<span id="changeprice">350</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      >
          ...
          775 DC Motor is the high torque DC Motor.It is used for drilling in wood,wall and other other parts related to drilling.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >775 DC Motor Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>12-24V DC RS-775 Motor</li>
        <li>No Load Power Consumption</li>
        <li>High Torque Rated Voltage</li>
        <li>Drilling, grinding and other electric drilling work</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
