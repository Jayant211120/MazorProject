...
<html lang="en">
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/infrarad sensor.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>IR Sensor Module - LM393 Photoelectric Sensor Module</span>
        ...
        <div class="stars">
          ...
          <span>Subtotal:<span id="changeprice">30</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        Photoelectric sensor module is a sensor module which you can use to
        identify the distance between obstacles, identifying changes in
        surroundings etc. applications. It has an IR transmitter, IR Receiver,
        LM393 and a potentiometer to set a threshold for digital output. When
        light brightness of ambient is less than the set threshold, DO-side
        output is high, when light brightness of ambient is over the threshold,
        DO-ended output is low. This module can be used in obstacle detection in
        autonomous robots and cars, in positional feedback for control system,
        industrial safety system, Wheel encoder etc.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >Infrared Sensor Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>5V DC operating voltage</li>
        <li>I/O pins are 5V and 3.3V compliant</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
