...
<html lang="en">
  <head>
    ...
    <title>Motors</title>
    <link rel="stylesheet" href="arduinonanodiscountkesath.css" />
    <!-- Icons CDS -->
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/arduino uno.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>Arduino Nano Cable</span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        This is the standard USB Type-A to USB Mini Type-B Arduino Programming
        cable that could be used to program Arduino Nano boards. It is needed to
        establishcommunication between the Arduino board and your computer so
        that you can send and receive the data from the board and program it
        according to your needs. The cable is 1 foot long. You need to connect
        one end to your computer and the other to the Arduino Development Board
        to program the Arduino. It is necessary for you to use high-quality
        connection cable because faulty cables might result in the errors and
        even an electrical short if abused which will damage your board beyond
        repair.
      </p>
      <span
        style="
          ...
          padding: 10px 0px;
        "
        >Arduino UNO Cable Specifications</span
      >
      <ul
        style="
          font: 20px solid;
      ...
      >
        ...
        <li>Aluminium under mold Shielding</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
