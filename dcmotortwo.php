  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>A2212 10T/13T 1400kV BLDC Motor</span>
        ...
        <div class="stars">
          ...
          <span>Subtotal:<span id="changeprice">360</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      >
          ...
          A2212 BLDC Motor is a 3-phase out -runner type popular BLDC motor
          commonly used in Drones and other multirotor application.The motor is
          rated for 1400KV and has an efficiency of 80%.The A2212 motr requires
          an ESC to control its speed.The motor can be easily be controlled with
          our 30A ESC and when coupled with our 1045 propeller Blades it can
          provides trust up to 1000gms.Four of these A2212 Motors can be easily
          mounted on the F450 Quadcopter Frame to provide a total thrust of 4kgs
          enabling you to build powerful drones.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >A2212 BLDC Motor Specifications</span
      >
      <ul
        style="
          font: 20px solid;
