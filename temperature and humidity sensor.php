...
<html lang="en">
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/temperature and humidity sensor.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>DHT11 Temperature and Humidity Sensor Module</span>
        <div class="stars">
          <div class="starsrow">
          ...
          <span>Subtotal:<span id="changeprice">70</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      >
        ...
        available, which is DHT22 Sesnor with higher sensing ranges. The sensor
        uses a capacitive humidity sensor and a thermistor based temperature
        sensor to measure the ambient humidity and temperature. The humidity
        sensing ranges from 20% to 90% with ±5% accuracy and the temperature
        sensing ranges from 0 degrees to the 50 degrees Celcius with ±2°C
        accuracy. The sampling time of this sensor is 2 seconds almost. This
        Temperature and Humidity Sensor uses digital pins to communicate with
        the microcontroller unit and does not have any kind of analog pins. The
        module also has the inbuilt pull-up resistor and additional filter
        ...
        unit without using any kind of additional components.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >DHT11 Temperature and Humidity Sensor Module</span
      >
      <ul
        style="
          font: 20px solid;
      ...
      >
        ...
        <li>Digital I/O</li>
        <li>5Hz sampling rate</li>
        <li>Measuring current:0.3mA</li>
        <li>Humidity range:20% to 90%</li>
        <li>Temperature range:0 to 50 Degree Celcius</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
