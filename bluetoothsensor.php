...
<html lang="en">
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/bluetooth sensor.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span
          >HM-10 Bluetooth Module - AT-09 Bluetooth 4.0 UART Transceiver Module
          CC2541</span
        >
        ...
        <div class="stars">
          ...
          <span style="padding: 2rem 0px">Availability:400 in stock</span>
          ...
          <span>Subtotal:<span id="changeprice">250</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        HM-10 Bluetooth module is a Bluetooth Low Energy (Bluetooth 4.0)
        development module based on the CC02541 Chip from Texas Instruments. The
        module communicates through UART protocol using AT commands. It can be
        used to communicate with all BLE devices like Fitness bands, Bluetooth
        trackers etc or even used as an iBeacon. The module has a built-in CPU
        that supports IO expansion, 14-bit two channel ADC, 120Hz four channel
        PWM etc. It has a range of 60 meters and consumes very low power in
        standby mode. The module can act both as a Master and as a Slave.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >Bluetooth Sensor Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>Input Supply voltage (V) : 5</li>
        <li>USB Protocol : USB V2.0</li>
        <li>Operating Frequency : 2.4GHz ISM band</li>
        <li>Modulation Mode : GFSK</li>
        <li>Transmitting Power (dBm) : ≤4</li>
        <li>Coverage Range (m) : 60</li>
