  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>Generic 0826U40KLRA Q L293D Motor Driver/Stepper/Servo Shield for Arduino</span>
        ...
        <div class="stars">
          ...
          <span style="padding: 2rem 0px">Availability:100 in stock</span>
          ...
          <span>Subtotal:<span id="changeprice">200</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
      2 connections for 5v 'hobby' servos connected to the arduino's high-resolution dedicated timer<br>
      4 h-bridges: L293d chipset provides 0.6a per bridge with thermal shutdown protection<br>
      Up to 2 stepper motors with single coil, double coil or interleaved stepping<br>
      Has internal kickback protection diodes<br>
      weight: 0.2 gms<br>
      </p>
    </div>
    >
