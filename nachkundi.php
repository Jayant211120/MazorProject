...
<html lang="en">
  <head>
    ...
    <title>Motors</title>
    <link rel="stylesheet" href="nachkundikesath.css" />
    <!-- Icons CDS -->
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/twizer.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>ESD-15 Anti Static Tweezer</span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        These are anti static tweezer with bent tip and made of high-strength
        stainless steel with anti-static non-magnetic paint on the surface.
        These tweezers are quite handy for engineers for precision work,
        repairing and reworking on electronic devices.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >ESD-15 Anti Static Tweezer Specifications</span
      >
      <ul
        style="
          font: 20px solid;
