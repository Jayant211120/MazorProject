...
<html lang="en">
  <head>
    ...
    <title>Motors</title>
    <link rel="stylesheet" href="paymentpagekesath.css" />
    <!-- Icons CDS -->
    <link
      rel="stylesheet"
...
<label for=""id='centerlabel'> Welcome in Payment Page</label>
<div class="rotatetwo">
...
<div class="arrowtwopointthree"></div>
    ...
    <!-- -------Configure images------------------------------------------------------------------------- -->
    <section id="payment">
        <form action="complete.php"style='position:relative;z-index:-1;'method=POST>
            <label for=""style='position:absolute;top:50%;font:3rem solid;left:43%;'>QR Code</label><br>
            <img src='Images/QRcode.jpeg'alt='No Image Found'style='position:absolute;top:10rem;left:40%;'name='img'><br>
            <label for=""style='position:absolute;top:43rem;left:38%;font:4rem solid;'>Cash on Delivery</label>
            <input type='radio'name='rdio'style='position:absolute;top:45rem;left:35%'>
            <input type='submit'name='btn'style='position:absolute;top:50rem;left:39%;width:30%;font:30px solid;cursor:pointer;background-color:orange;color:white;border-radius:20px'>
        </form>
    </section>
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
    <section id="footer">
