  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span
          >Super Debug 16-Channel 12-bit PWM/Servo Driver I2C interface
          PCA9685</span
        >
        ...
        <div class="stars">
          ...
          <span style="padding: 2rem 0px">100 in stock</span>
          ...
          <span>Subtotal:<span id="changeprice">750</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      12-bit resolution for each output - for servos, that means about 4us resolution at a 60Hz update rate<br>
      Configurable push-pull or an open-drain output<br>
      The output enable pin to quickly disable all the outputs<br>
      Terminal block for power input<br>
      </p>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
