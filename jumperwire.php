...
<html lang="en">
  ...
  <body>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/jumper.jfif" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>Female to Female Jumper Wires each set(10 Pieces)</span>
        ...
        <div class="stars">
          ...
          <span>Subtotal:<span id="changeprice">20</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        This is a set of 10 rainbow color male to female jumper wires. They can
        be used for interconnecting electronic components on breadboard or berg
        strips. The wires are 20 cm long. One side has a male header and the
        other end is a female header.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >Jumper Wires Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>Easy to Plug In</li>
        <li>1x20 Female to Female breadboard connecting wires</li>
        <li>Multiple colors</li>
        <li>Current Rating:upto 1 A</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
