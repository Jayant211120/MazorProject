  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>Arduino Nano (Soldered)</span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      >
        ...
        connectivity and specs of Arduino Uno in a small package. DC Power Jack
        is not available on this board so power can only be supplied by a Mini B
        USB port present on it or 6-20V unregulated external power supply from
        Pin 30 (Vin). Due to its small size its very popular among IoT based
        projects which need to be small and user friendly, in Robotics, in
      ...
      <span
        style="
          ...
          padding: 10px 0px;
        "
        >Arduino Nano Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>It has 22 I/O pins in total in which 14 are Digital (6 are PWM output) and 8 are Analog pins.</li>
