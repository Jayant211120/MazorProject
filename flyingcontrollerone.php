...
<html lang="en">
  ...
  <body>
          ...
          <li class="list">
            <a href="#" class="outer-color"
              ...
              <ul class="un">
                <li id="motors-hover">
                  <a href="motors.php"
                    >Motors<span style="color: red">*</span></a
                  >
                </li>
    ...
    <section id="insideimage">
      <div class="bigimage">
        <img src="Images/flying controller.jpg" alt="No Image Found" />
      </div>
      <div class="imagecontent">
        <span>Pixhawk 2.4.8 Drone Flight Controller Px4 32 bit Autopilot</span>
        ...
        <div class="stars">
          ...
          <span>Subtotal:<span id="changeprice">1170</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
        This is a best flying controller for drones and robots.It is provided best stability for drone
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >Pixhawk Flying Controller Specifications</span
      >
      <ul
        style="
          font: 20px solid;
        ...
        "
      >
        <li>Multicolor LED Light</li>
        <li>Supply Voltage:12PWM</li>
        <li>Bus interface (UART,12C,SPI,CAN)</li>
        <li>Flying data recording is also available</li>
      </ul>
    </div>
    >
    <!------Footer Section ------------------------------------------------------------------------------------------ -->
