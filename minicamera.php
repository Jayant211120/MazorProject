  ...
  <body>
    ...
    <section id="insideimage">
      ...
      <div class="imagecontent">
        <span>HD Plus Mini Hidden Camera</span>
        ...
        <div class="stars">
          ...
          <span>Subtotal:<span id="changeprice">800</span></span>
    ...
    <div class="center" style="position: absolute; top: 60rem; z-index: -1">
      ...
      <p
        ...
        "
      >
       This mini camera is used for hidden areas as well as used for security purpose.It is very
       small in size,so it can carry easily.
      </p>
      <span
        style="
          font: 25px solid;
          ...
          padding: 10px 0px;
        "
        >HD Mini Camera Specifications</span
      >
      <ul
        style="
          font: 20px solid;
      ...
      >
        ...
        <li>
            Audio and video Recording(both are Available).
        </li>
        <li>
            Video Resolution:1280 x 720P
        </li>
        <li>
            Build in Lithium battery work on 40 to 50 Minutes
        </li>
      </ul>
    </div>
    >
